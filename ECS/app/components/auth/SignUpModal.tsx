...
export default function SignUpModal({ isOpen, onClose, onOpenLogin, isInstructor }: SignUpModalProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const success = await signup(email, password, firstName, lastName, isInstructor)
    if (success) {
      onClose()
      if (isInstructor) {
        // Redirect to instructor onboarding or dashboard
      ...
      <DialogContent className="sm:max-w-[800px] p-0 overflow-hidden">
        <div className="grid grid-cols-1 md:grid-cols-2">
          ...
          <div className="relative hidden md:block">
            ...
            <div className="absolute bottom-6 left-6 text-white">
              <div className="flex items-center gap-3 mb-2">
                <Image src="/joe-avatar.png" alt="Joe Kitanoe" width={48} height={48} className="rounded-full" />
                <div>
                  <h3 className="font-semibold">Joe Kitanoe</h3>
          ...
          <div className="p-6">
            ...
            <h2 className="text-2xl font-bold mb-4">{isInstructor ? "Become an Instructor" : "Sign Up"}</h2>
            ...
            <div className="text-center">
              <p className="text-gray-600">
                ...
                <Link href="#" onClick={handleLoginClick} className="text-indigo-600 hover:underline font-medium">
                  Sign In
                </Link>
              </p>
            </div>
